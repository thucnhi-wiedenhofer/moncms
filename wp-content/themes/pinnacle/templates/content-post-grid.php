                          ...
                          if(empty($image[0])) {$image = array($thumbnailURL,$image_width,$image_height);} ?>
                              <div class="imghoverclass img-margin-center">
                                <a href="<?php the_permalink()  ?>" title="<?php the_title_attribute(); ?>">
                                  	<img src="<?php echo esc_url($image[0]); ?>" alt="<?php the_title_attribute(); ?>" width="<?php echo esc_attr($image[1]);?>" height="<?php echo esc_attr($image[2]);?>" <?php echo kt_get_srcset_output( $image[1], $image[2], $thumbnailURL, $image_id);?> class="iconhover" style="display:block;">
                                </a> 
                              </div>
                                          ...
                                          foreach ($attachments as $attachment) {
                                            ...
                                            <li>
                                                <a href="<?php the_permalink() ?>">
                                                	<div>
	                                                    <img src="<?php echo esc_url($image[0]);?>"  width="<?php echo esc_attr($image[1]);?>" height="<?php echo esc_attr($image[2]);?>" <?php echo kt_get_srcset_output( $image_width, $image_height, $attachment_url, $attachment);?> class="" alt="<?php esc_attr($attachment_post->post_excerpt);?>" />
						                            </div>
                                                </a>
                                            </li>
                                          <?php }
